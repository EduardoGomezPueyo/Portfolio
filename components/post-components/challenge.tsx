...
const Challenge = ({ title, children, className, image, altText, subtitle, accentColor }: ChallengeProps) => {
        ...
        <div className={className}>
            <div className="pt-24 pb-20 flex flex-col sm:flex-row w-full sm:w-[60%] mx-auto gap-8 min-h-[50vh] items-center">
                <div className="w-full sm:w-[60%] my-auto px-10 sm:px-0">
                    <h3 className={classNames("mb-2 text-lg sm:text-2xl font-semibold uppercase", accentColor)}>{subtitle}</h3>
